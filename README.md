...
Overall upward or stable trend depending on economic factors.
High variability influenced by business activity, regulatory changes, and external events.

Forecasting Results

SARIMAX model fitted with order (1,0,0) and seasonal order (0,1,1,12) — capturing both trend and yearly seasonality.
25-month forecast generated showing projected revenue trajectory.
Model highlights expected growth or stabilization in permit revenue.
